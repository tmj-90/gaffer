...
**While decomposing, you settle a cross-cutting decision — the stack, the layout convention, a phase-ordering constraint other agents must follow.** That kind of fact is *lore*. Capture it via the **lore-capture
